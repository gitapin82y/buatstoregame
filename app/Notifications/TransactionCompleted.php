...
// app/Notifications/TransactionCompleted.php
...
class TransactionCompleted extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line('Pesanan Anda telah berhasil diselesaikan.')
            ...
            ->line('Status: Selesai')
            ->action('Lihat Detail', route('user.transactions.show', $this->transaction->id))
