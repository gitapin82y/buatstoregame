                ...
                <form action="{{ route('admin.games.update', $game->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4">{{ old('description', $game->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($game->logo)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $game->logo) }}" alt="{{ $game->name }}" class="img-thumbnail" style="max-height: 100px;">
                                </div>
                            @endif
                            @error('logo')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($game->banner)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $game->banner) }}" alt="{{ $game->name }}" class="img-thumbnail" style="max-height: 100px;">
                                </div>
                            @endif
                            @error('banner')
                                <div class="invalid-feedback">{{ $message }}</div>
