<!-- resources/views/admin/games/services/options/create.blade.php -->
@extends('layouts.admin')

@section('title', 'Add New Option')

@section('page-title', 'Add New Option for ' . $service->name)
...
<div class="row mt-4">
    ...
    <div class="col-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('admin.games.services.options.store', ['game' => $game->id, 'service' => $service->id]) }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('api_code') is-invalid @enderror" id="api_code" name="api_code" value="{{ old('api_code') }}">
