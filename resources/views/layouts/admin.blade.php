    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 text-white fs-4 fw-bold">
                <i class="fas fa-gamepad me-2"></i>BuatTokoGame
            </div>
            <div class="list-group list-group-flush my-3">
                ...
                <a href="{{ route('admin.resellers.index') }}" class="list-group-item list-group-item-action bg-transparent text-white {{ request()->routeIs('admin.resellers*') ? 'active' : '' }}">
                    <i class="fas fa-users me-2"></i>Resellers
                </a>
                <a href="{{ route('admin.games.index') }}" class="list-group-item list-group-item-action bg-transparent text-white {{ request()->routeIs('admin.games*') ? 'active' : '' }}">
                    <i class="fas fa-gamepad me-2"></i>Games
                </a>
                <a href="{{ route('admin.membership-packages.index') }}" class="list-group-item list-group-item-action bg-transparent text-white {{ request()->routeIs('admin.membership-packages*') ? 'active' : '' }}">
                    <i class="fas fa-box me-2"></i>Packages
                </a>
                <a href="{{ route('admin.transactions.index') }}" class="list-group-item list-group-item-action bg-transparent text-white {{ request()->routeIs('admin.transactions.index') || request()->routeIs('admin.transactions.show') ? 'active' : '' }}">
                    <i class="fas fa-exchange-alt me-2"></i>Transactions
                </a>
                <a href="{{ route('admin.transactions.membership.index') }}" class="list-group-item list-group-item-action bg-transparent text-white {{ request()->routeIs('admin.transactions.membership*') ? 'active' : '' }}">
